...
* [First Time Login](getting-started/first-time-login/README.md)
  * [DCMS OpenMRS](getting-started/first-time-login/dcms-openmrs.md)
  * [ODOO](getting-started/first-time-login/odoo.md)
...
* [Main functional areas](navigation-and-interface-overview/main-functional-areas/README.md)
  ...
  * [Accessing a Service User File](navigation-and-interface-overview/main-functional-areas/accessing-a-service-user-file/README.md)
    * [Accessing a New Service User File - P\&O](navigation-and-interface-overview/main-functional-areas/accessing-a-service-user-file/accessing-a-new-service-user-file-p-and-o.md)
  * [Create a Material Request](navigation-and-interface-overview/main-functional-areas/create-a-material-request/README.md)
    * [Create a Material Request - P & O](navigation-and-interface-overview/main-functional-areas/create-a-material-request/create-a-material-request-p-and-o.md)
    * [Create a BOM (verify components/qty)](navigation-and-interface-overview/main-functional-areas/create-a-material-request/create-a-bom-verify-components-qty.md)
    * [Stock Management for New Material Request](navigation-and-interface-overview/main-functional-areas/create-a-material-request/stock-management-for-new-material-request.md)
...
* [Creating a New Record / Entry](core-functionalities/creating-a-new-record-entry/README.md)
  ...
  * [Creating a Basic Service Plan & Clinical Consent](core-functionalities/creating-a-new-record-entry/creating-a-basic-service-plan-and-clinical-consent/README.md)
    * [Interdisciplinary Team](core-functionalities/creating-a-new-record-entry/creating-a-basic-service-plan-and-clinical-consent/interdisciplinary-team.md)
    * [Receptionist](core-functionalities/creating-a-new-record-entry/creating-a-basic-service-plan-and-clinical-consent/receptionist.md)
* [Performing Core Actions](core-functionalities/performing-core-actions.md)
  * [Cancelling an Order](core-functionalities/performing-core-actions/cancelling-an-order.md)
  * [Financial Assessment](core-functionalities/performing-core-actions/financial-assessment/README.md)
    * [Social worker](core-functionalities/performing-core-actions/financial-assessment/social-worker.md)
  * [Starting Services](core-functionalities/performing-core-actions/starting-services/README.md)
    * [Start Any Form Services](core-functionalities/performing-core-actions/starting-services/start-any-form-services.md)
    * [Technical Cards](core-functionalities/performing-core-actions/starting-services/technical-cards.md)
    * [Final Assessment Outcome and Goal Setting](core-functionalities/performing-core-actions/starting-services/final-assessment-outcome-and-goal-setting.md)
  * [Follow-up Services](core-functionalities/performing-core-actions/follow-up-services/README.md)
    * [Initial Decision After Registration](core-functionalities/performing-core-actions/follow-up-services/initial-decision-after-registration.md)
    * [Service Follow-up Assessment](core-functionalities/performing-core-actions/follow-up-services/service-follow-up-assessment.md)
    * [Financial Capacity Assessment](core-functionalities/performing-core-actions/follow-up-services/financial-capacity-assessment.md)
    * [Service Follow-up Plan](core-functionalities/performing-core-actions/follow-up-services/service-follow-up-plan.md)
  * [Manufacturing the Device (Greenlight, Quality Check)](core-functionalities/performing-core-actions/manufacturing-the-device-greenlight-quality-check/README.md)
    * [Create the Production Order](core-functionalities/performing-core-actions/manufacturing-the-device-greenlight-quality-check/create-the-production-order.md)
    * [Changing the scheduled date](core-functionalities/performing-core-actions/manufacturing-the-device-greenlight-quality-check/changing-the-scheduled-date.md)
    * [Planning the Scheduled Date for Order](core-functionalities/performing-core-actions/manufacturing-the-device-greenlight-quality-check/planning-the-scheduled-date-for-order.md)
    * [Confirm the Order](core-functionalities/performing-core-actions/manufacturing-the-device-greenlight-quality-check/confirm-the-order.md)
    * [Validation Process](core-functionalities/performing-core-actions/manufacturing-the-device-greenlight-quality-check/validation-process.md)
    * [Delivery of Components by the Storekeeper](core-functionalities/performing-core-actions/manufacturing-the-device-greenlight-quality-check/delivery-of-components-by-the-storekeeper.md)
    * [Preparation of the order](core-functionalities/performing-core-actions/manufacturing-the-device-greenlight-quality-check/preparation-of-the-order.md)
    * [If the item is traced (batch number – unique serial number).](core-functionalities/performing-core-actions/manufacturing-the-device-greenlight-quality-check/if-the-item-is-traced-batch-number-unique-serial-number-..md)
    * [Partial Delivery](core-functionalities/performing-core-actions/manufacturing-the-device-greenlight-quality-check/partial-delivery.md)
