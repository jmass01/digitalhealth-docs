...
Décision initiale après l'enregistrement et décision d'envoyer pour un nouveau service (enregistrer et valider)
{% endstep %}

{% step %}
#### Évaluation initiale (équipe interdisciplinaire)

* Résultat initial et définition des objectifs (évaluations optionnelles)
* Plan de service de base + consentement clinique (planifier le service)
{% endstep %}

{% step %}
#### Évaluation de la capacité financière

(si non approuvé) Évaluation socio-économique + décision de financement
{% endstep %}
