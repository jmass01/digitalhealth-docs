...
**Answer**_: Refresh the page (by clicking F5 on your keyboard) and click on "Monthly Reports" (1) clear all filters (2). Then, put unique data in the filter fields (3) to find the report you need. (i.e. month, structure, status – filters can vary according to the MAD, here below view from MAD PRP ) and hit Apply (4)._
